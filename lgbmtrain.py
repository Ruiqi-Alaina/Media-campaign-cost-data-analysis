...
parser.add_argument('--lambda_l1', dest='reg_term', type=float)
...
# data preprocessing 
#num_attrib = ["store_sales(in millions)", "unit_sales(in millions)","independent_children","avg_cars_at home(approx).1", "gross_weight","units_per_case", "store_sqft"]
...
expRun.log_params({'learning_rate':args.learning_rate, 'max_depth': args.max_depth, 'lambda_l1': args.reg_term,'num_leaves':args.num_leaves})
...
y_pred_training = model_lgbm.predict(x_train)
